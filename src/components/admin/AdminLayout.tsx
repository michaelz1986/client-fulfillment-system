...
export default function AdminLayout() {
  ...
  const navItems = [
    ...
    { path: '/admin/products', label: 'Produkte', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
  ];
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-dark-700">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-dark-400 truncate">{state.currentUser?.email}</p>
            </div>
          </div>
          <button
            onClick={handleLogout}
            className="w-full flex items-center justify-center gap-2 px-4 py-2 text-sm text-dark-300 hover:text-white hover:bg-dark-800 rounded-lg transition-colors"
          >
