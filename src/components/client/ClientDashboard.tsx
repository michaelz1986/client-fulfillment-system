          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className={`font-medium ${
                isDone ? 'text-green-800' : isCurrent ? 'text-blue-900' : isLocked ? 'text-slate-400' : 'text-slate-700'
              }`}>
                {milestone.title}
              </div>
    ...
    <div className={`rounded-3xl p-8 md:p-12 border-2 ${
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <button
          ...
          className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-4 bg-green-600 hover:bg-green-700 disabled:bg-green-400 text-white rounded-xl font-semibold text-lg transition-all"
        >
          {isSubmitting ? (
            <>
